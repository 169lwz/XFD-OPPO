...
<html class='no-js'>
  ...
  <div class='upper-area'>
    ...
    <li class='gi hidden hasLogin' data-desktop='.upper-area .log-area' data-mobile='.mobile-tools .log-area'>
      <a class='logout' href='https://id.oppo.com/logout?callback=http%3A%2F%2Fwww.opposhop.cn%2Fcoupons%2Fshow'>退出</a>
    </li>
    <li class='gi hasLogout' data-desktop='.upper-area .log-area' data-mobile='.mobile-tools .log-area'>
      <a href='https://id.oppo.com/login?callback=http%3A%2F%2Fwww.opposhop.cn%2Fcoupons%2Fshow'>
        登录
      </a>
    </li>
    <li class='gi hasLogout' data-desktop='.upper-area .log-area' data-mobile='.mobile-tools .log-area'>
      <a href='https://id.oppo.com/register/sms?type=1&callback=http%3A%2F%2Fwww.opposhop.cn%2Fcoupons%2Fshow'>
        注册
      </a>
    </li>
...
<div class='relative'>
  <ul>
    ...
    <li class='user-menu-logout'>
      <a href='https://id.oppo.com/logout?callback=http%3A%2F%2Fwww.opposhop.cn%2Fcoupons%2Fshow'>退出</a>
    </li>
  </ul>
</div>
</div>    </div>
          ...
          <div class="alert alert-danger" role="alert">
            <ul class="list-unstyled">
              <strong class='error_msg_note'>
                  ...
                  <div class="brick-shadow coupons-none">
        <p class="coupons-none-tip">您暂时还没有优惠券哦！</p>
        <p>（偷偷告诉你，多多参与官网活动，就有可能获得优惠券呐！）</p>
      </div>
	      </div>
  </main>
...
电子标识有效期：2015-12-14～2020-12-16" class="footer-identification"></a>
  ...
  $(document).ready(function(){
    $('.coupons-item .g').on('click', function(event) {
    ...
    (function () {
        var controllerNameWithAction = "CouponsController@show".split('@');
