  ...
  <div class="upper-area">
    <div class="wrapper g">
      <ul class="gi log-area">
        ...
        <li class="gi hasLogin show" data-desktop=".upper-area .log-area" data-mobile=".mobile-tools .log-area">
          <a class="logout" href="https://id.oppo.com/logout?callback=http%3A%2F%2Fwww.opposhop.cn%2Ftrade">退出</a>
        </li>
        <li class="gi hasLogout hidden" data-desktop=".upper-area .log-area" data-mobile=".mobile-tools .log-area">
          <a href="https://id.oppo.com/login?callback=http%3A%2F%2Fwww.opposhop.cn%2Ftrade">
            登录
          </a>
        </li>
        <li class="gi hasLogout hidden" data-desktop=".upper-area .log-area" data-mobile=".mobile-tools .log-area">
          <a href="https://id.oppo.com/register/sms?type=1&amp;callback=http%3A%2F%2Fwww.opposhop.cn%2Ftrade">
            注册
          </a>
        </li>
      </ul>      
...
<a href="/shop/index">
    ...
    <span id="shopping-count" class="n-item-cart cart_number">0</span>
  </a>
</div>      <div class="logo logo-extend">
        <a href="http://www.oppo.com/cn/">
          <img src="/txdd/logo.png" alt="">
        </a>
      </div>
      <a class="js-open-user point-red" href="#">
        <img src="/txdd/icon-menu-user.png" alt="">
      </a>
      <div class="main-menu">
...
<div class="relative">
  <ul>
    ...
    <li class="user-menu-logout">
      <a href="https://id.oppo.com/logout?callback=http%3A%2F%2Fwww.opposhop.cn%2Ftrade">退出</a>
    </li>
  </ul>
</div>
</div>    </div>
  ...
  <ul class="g">
    ...
    <div class="gi lap-one-quarter align-right">
      <div class="one-half lap-one-whole contact-online">
        <a href="http://oim.oppo.com/oim/chatClient/chatbox.jsp?companyID=8092&amp;configID=890&amp;enterurl=http%3A%2F%2Foim%2Emyoppo%2Ecom%2Foim%2Fpreview%2Ejsp&amp;pagereferrer=http%3A%2F%2Foim%2Emyoppo%2Ecom%2Foim%2FembedScript%2Ejsp%3Ft%3D1517&amp;k=1" target="_blank"><img src="/txdd/icon-online.png" alt=""></a>
      </div>
