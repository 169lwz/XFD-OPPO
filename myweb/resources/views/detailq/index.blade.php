...
<script>
    ...
    <script src="/detail/js/jquery-1.9.1.min.js"></script>
  ...
  <a href='http://www.opposhop.cn/cart'>
    ...
    <span class='n-item-cart cart_number' id="shopping-count">0</span>
        ...
        <a href='http://www.oppo.com/cn/'>
          <img src="/detail/images/logo.png" alt="">
        </a>
   
      </div>
      <a class='js-open-user' href='#'>
        <img src="/detail/images/icon-menu-user.png" alt="">
      </a>
      <div class='main-menu'>
  ...
  <footer class='main-footer'>
    ...
    <div class="gi lap-one-quarter align-right">
      <div class="one-half lap-one-whole contact-online">
        <a href="http://oim.oppo.com/oim/chatClient/chatbox.jsp?companyID=8092&configID=890&enterurl=http%3A%2F%2Foim%2Emyoppo%2Ecom%2Foim%2Fpreview%2Ejsp&pagereferrer=http%3A%2F%2Foim%2Emyoppo%2Ecom%2Foim%2FembedScript%2Ejsp%3Ft%3D1517&k=1" target="_blank"><img src="/detail/images/icon-online.png" alt=""></a>
      </div>
  ...
  <div class="g wrapper">
    <div class="footer-linear"></div>
          ...
          <div class='gi lap-one-whole one-whole'>
            <a href='#' id="btn-kf"><img src='/detail//cn/media/images/zxkf.png' /></a>
          </div>
          <div class='gi footer-lap-hide one-third'><img alt='' src='/detail//cn/media/images/m.jpg' /></div>
        </div> -->
    ...
    <div class='wrapper'>
        ...
        <a href='#' class='footer-focus-icon footer-focus-wechat relative'>
          ...
          <img src="/detail/images/qrcode-wx.jpg" class="wx-float" alt="">
        </a>
        <a href='#' class='footer-focus-icon footer-focus-fuwuchuang relative'>
          <span class='icon icon-fuwuchuang'></span>
          <img src="/detail/images/qrcode-fwc.jpg" class="wx-float" alt="">
        </a>
      </div>
      <p class='copy'>© 2005 - 2017 东莞市永盛通信科技有限公司 版权所有 粤ICP备14056724号-2 联系方式：4001-666-888</p>
      <a href="http://wljg.gdgs.gov.cn/corpsrch./detail/aspx?key=441900000436441" target="_blank" title="企业名称：广东欧珀电子工业有限公司
法定代表人：金乐亲
...
<noscript><img src="/detail/other/img?site=1351" style="border:0" alt="" /></noscript> 
<!--听云监测-->
<script src="/detail/js/tingyun-rum.js"></script>
<script type="text/javascript">
$(function(){
