...
<html style="" class=" js no-touch backgroundsize cssanimations csstransforms svg inlinesvg"><head>
    ...
    <link media="all" type="text/css" rel="stylesheet" href="tianxiedingdan1_files/styles.css">

    <script src="tianxiedingdan1_files/uta.js" async="" defer="defer" type="text/javascript"></script><script src="tianxiedingdan1_files/optj-1.js"></script><script src="tianxiedingdan1_files/analytics.js" async=""></script><script src="tianxiedingdan1_files/hm.js"></script><script type="text/javascript">
    ...
    <![endif]-->
    <script src="tianxiedingdan1_files/modernizr.js"></script>
  ...
  <div class="upper-area">
    ...
    <li class="gi hasLogin show" data-desktop=".upper-area .log-area" data-mobile=".mobile-tools .log-area">
      ...
      <a href="https://id.oppo.com/login?callback=http%3A%2F%2Fwww.opposhop.cn%2Forders">
        登录
      </a>
    </li><li class="gi hasLogout hidden" data-desktop=".upper-area .log-area" data-mobile=".mobile-tools .log-area">
      <a href="https://id.oppo.com/register/sms?type=1&amp;callback=http%3A%2F%2Fwww.opposhop.cn%2Forders">
        注册
      </a>
...
<li class="gi gi-language" data-desktop=".menu-lang" data-mobile=".main-menu nav .nav-ul-view &gt; ul">
  ...
  <a href="http://www.opposhop.cn/cart">
    ...
    <span class="n-item-cart cart_number" id="shopping-count">6</span>
  </a>
</div>      <div class="logo logo-extend">
        <a href="http://www.oppo.com/cn/">
          <img src="tianxiedingdan1_files/logo.png" alt="">
        </a>
      ...
      <a class="js-open-user point-red" href="#">
        <img src="tianxiedingdan1_files/icon-menu-user.png" alt="">
      </a>
      <div class="main-menu">
...
<div class="relative">
  <ul>
    ...
    <li class="user-menu-logout">
      <a href="https://id.oppo.com/logout?callback=http%3A%2F%2Fwww.opposhop.cn%2Forders">退出</a>
    </li>
  </ul>
</div>
</div>    </div>
...
<div class="nav-search">
  ...
  <div class="gi one-whole desk-one-half">
    订单编号：<strong><a class="clickable order-id" href="http://www.opposhop.cn/orders/170207151600174/show">170207151600174</a></strong>
  </div>
...
<div class="order-list">
  <div class="order-item order-product desk-text-align-center">
          <a href="http://www.opposhop.cn/products/393" target="_blank">
                  <img class="order-product-thumbnail" alt="" src="tianxiedingdan1_files/2016120610125258462660023ba.png">
              </a>
...
<div class="row">
      <a href="http://www.opposhop.cn/products/393" target="_blank">R9s 黑色版 静如墨玉</a>
        ...
        <p class="row">
      <a href="http://www.opposhop.cn/orders/170207151600174/show">+其余1款商品</a>
    </p>
      </div>
  ...
  <div class="order-item order-amount desk-text-align-center">
    <span class="order-desk-hide">订单金额：</span>¥2799.00
  </div>
  <div class="order-item order-detail">
    <div class="row order-username">邹军</div>
    <div class="row">18341343073</div>
        <div class="row">820170748@qq.com</div>
    <div class="row">辽宁省朝阳市北票市南山街道步步高</div>
          </div>
  <div class="order-item order-primary desk-text-align-center">
    <div class="row">订单状态：未付款</div>
        <div class="row"><a class="button button-s" href="http://www.opposhop.cn/orders/170207151600174/payments">立即支付</a></div>
            <div class="row"><a class="button button-s" href="http://www.opposhop.cn/orders/170207151600174/show">查看详情</a></div>

                  <div class="row"><a class="box-link" href='javascript:%20vm.cancel("170207151600174");'>取消订单</a></div>
            </div>
</div>
        </div>
  ...
  <ul class="g">
    ...
    <div class="gi lap-one-quarter align-right">
      <div class="one-half lap-one-whole contact-online">
        <a href="http://oim.oppo.com/oim/chatClient/chatbox.jsp?companyID=8092&amp;configID=890&amp;enterurl=http%3A%2F%2Foim%2Emyoppo%2Ecom%2Foim%2Fpreview%2Ejsp&amp;pagereferrer=http%3A%2F%2Foim%2Emyoppo%2Ecom%2Foim%2FembedScript%2Ejsp%3Ft%3D1517&amp;k=1" target="_blank"><img src="tianxiedingdan1_files/icon-online.png" alt=""></a>
      </div>
  ...
  <div class="g wrapper">
    ...
    <div class="wrapper">
        ...
        <a href="#" class="footer-focus-icon footer-focus-wechat relative">
          ...
          <img src="tianxiedingdan1_files/qrcode-wx.jpg" class="wx-float" alt="">
        </a>
        <a href="#" class="footer-focus-icon footer-focus-fuwuchuang relative">
          <span class="icon icon-fuwuchuang"></span>
          <img src="tianxiedingdan1_files/qrcode-fwc.jpg" class="wx-float" alt="">
        </a>
      </div>
...
电子标识有效期：2015-12-14～2020-12-16" class="footer-identification"></a>
  ...
  <div class="navi-scroll-content">
    ...
    <script src="tianxiedingdan1_files/jquery-1.js"></script>

    <script src="tianxiedingdan1_files/jquery.js"></script>

    <script src="tianxiedingdan1_files/underscore-min.js"></script>

    <script src="tianxiedingdan1_files/es5-shim.js"></script>

    <script src="tianxiedingdan1_files/base64.js"></script>

    <script src="tianxiedingdan1_files/custom_form.js"></script>

    <script src="tianxiedingdan1_files/jquery_002.js"></script>

    <script src="tianxiedingdan1_files/slick.js"></script>

    <script src="tianxiedingdan1_files/responsive.js"></script>

    <script src="tianxiedingdan1_files/picturefill.js"></script>

    <script src="tianxiedingdan1_files/scripts.js"></script>

        <script src="tianxiedingdan1_files/opposhop.js"></script>
...
<noscript><img src="https://sit.gentags.net/site/img?site=1351" style="border:0" alt="" /></noscript> 

<!--听云监测-->
<script src="tianxiedingdan1_files/tingyun-rum.js"></script>
