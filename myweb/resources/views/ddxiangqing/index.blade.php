...
<html style="" class=" js no-touch backgroundsize cssanimations csstransforms svg inlinesvg"><head>
    ...
    <link media="all" type="text/css" rel="stylesheet" href="/ddxiangqing/index.blade_files/styles.css">
  ...
  <div class="upper-area">
    ...
    <li class="gi hasLogin show" data-desktop=".upper-area .log-area" data-mobile=".mobile-tools .log-area">
      ...
      <a class="logout" href="https://id.oppo.com/logout?callback=http%3A%2F%2Fwww.opposhop.cn%2Forders%2F170212025045677%2Fshow">退出</a>
    </li><li class="gi hasLogout hidden" data-desktop=".upper-area .log-area" data-mobile=".mobile-tools .log-area">
      <a href="https://id.oppo.com/login?callback=http%3A%2F%2Fwww.opposhop.cn%2Forders%2F170212025045677%2Fshow">
        登录
      </a>
    </li><li class="gi hasLogout hidden" data-desktop=".upper-area .log-area" data-mobile=".mobile-tools .log-area">
      <a href="https://id.oppo.com/register/sms?type=1&amp;callback=http%3A%2F%2Fwww.opposhop.cn%2Forders%2F170212025045677%2Fshow">
        注册
      </a>
  ...
  <a href="http://www.opposhop.cn/cart">
    ...
    <span class="n-item-cart cart_number" id="shopping-count">0</span>
        ...
        <a href="http://www.oppo.com/cn/">
          <img src="/ddxiangqing/index.blade_files/logo.png" alt="">
        </a>
      ...
      <a class="js-open-user" href="#">
        <img src="/ddxiangqing/index.blade_files/icon-menu-user.png" alt="">
      </a>
      <div class="main-menu">
...
<div class="relative">
  <ul>
    ...
    <li class="user-menu-logout">
      <a href="https://id.oppo.com/logout?callback=http%3A%2F%2Fwww.opposhop.cn%2Forders%2F170212025045677%2Fshow">退出</a>
    </li>
  </ul>
</div>
</div>    </div>
      ...
      <div class="goods-list-detail">
        <div class="goods-list-info goods-list-main">
          <div class="goods-list-description">
            <h4 class="heading">
              <a href="http://www.opposhop.cn/products/323" target="_blank">{{$v['goods']}}</a>
            </h4>
            <p>{{$v['desc']}}</p>
          </div>
...
@endforeach
  ...
  <div class="total-price slab-extra-light gi one-whole desk-one-third">
    ...
    <div class="total">
      ...
      <span class="price">￥{{$list1['total']}}.00</span>
    </div>
  ...
  <ul class="g">
    ...
    <div class="gi lap-one-quarter align-right">
      <div class="one-half lap-one-whole contact-online">
        <a href="http://oim.oppo.com/oim/chatClient/chatbox.jsp?companyID=8092&amp;configID=890&amp;enterurl=http%3A%2F%2Foim%2Emyoppo%2Ecom%2Foim%2Fpreview%2Ejsp&amp;pagereferrer=http%3A%2F%2Foim%2Emyoppo%2Ecom%2Foim%2FembedScript%2Ejsp%3Ft%3D1517&amp;k=1" target="_blank"><img src="/ddxiangqing/index.blade_files/icon-online.png" alt=""></a>
      </div>
  ...
  <div class="g wrapper">
    ...
    <div class="wrapper">
        ...
        <a href="#" class="footer-focus-icon footer-focus-wechat relative">
          ...
          <img src="/ddxiangqing/index.blade_files/qrcode-wx.jpg" class="wx-float" alt="">
        </a>
        <a href="#" class="footer-focus-icon footer-focus-fuwuchuang relative">
          <span class="icon icon-fuwuchuang"></span>
          <img src="/ddxiangqing/index.blade_files/qrcode-fwc.jpg" class="wx-float" alt="">
        </a>
      </div>
