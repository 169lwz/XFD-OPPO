...
<div class="mws-panel grid_8">
	<div class="mws-panel-header">
		<span><i class="icon-table"></i> 轮播图片浏览</span>
	</div>
                ...
                <tbody role="alert" aria-live="polite" aria-relevant="all">
                	@foreach($list as $k=>$v)
		                ...
		                @endif
		                        ...
		                        <td class=" " align='center'><img src="{{$v['pic']}}" style="width:200px"></td>
		                        ...
		                        <td class=" " align='center' font-size='30px'>
		                        	<a href='/admin/lunbo/del/{{$v['id']}}' class="icon-trash" style='font-size:25px;color:red' title='删除图片'></a> | <a href='/admin/lunbo/edit/{{$v['id']}}' class="icon-cogs" style='font-size:25px;color:green' title='修改'></a>
		                        </td>
		                    </tr>
                   	@endforeach
                </tbody>
