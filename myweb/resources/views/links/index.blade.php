		        ...
		        <tbody role="alert" aria-live="polite" aria-relevant="all">
			        ...
			        <!--判断奇偶行数, 实现隔行换色-->
				        ...
				        @endif				        
			                    ...
			                    <td class=" ">{{\App\Http\Controllers\LinksController::funame($v['pid'])}}</td>
			                    <td class=" ">{{$v['path']}}</td>
			                    <td class=" ">
									<a href="/admin/links/del/{{$v['id']}}" class="icon-trash" style="font-size:25px;color:orange"></a>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<a href="/admin/links/add/{{$v['id']}}" class="icon-plus" style="font-size:25px;color:orange"></a>	
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<a href="/admin/links/edit/{{$v['id']}}" class="icon-legal" style="font-size:25px;color:orange"></a>	
			                    </td>		                   
					      	</tr>
			        @endforeach
		        </tbody>
