<!DOCTYPE html>
<!-- saved from url=(0029)http://www.opposhop.cn/orders -->
<html class=" js no-touch backgroundsize cssanimations csstransforms svg inlinesvg"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <![endif]-->
    <script src="/myhome_files/modernizr.custom.js"></script>
...
<li class="gi gi-language" data-desktop=".menu-lang" data-mobile=".main-menu nav .nav-ul-view &gt; ul">
    <a class="lang-link js-toggle-close" href="http://www.opposhop.cn/orders#">Global</a>
  ...
  <div class="bottom-area">
    <div class="wrapper">
      <a class="js-open-menu" href="http://www.opposhop.cn/orders#">
  ...
  <a href="/shop/index">
    ...
    <span class="n-item-cart cart_number" id="shopping-count">{!!\App\Http\Controllers\ShopController::num()!!}</span>
      ...
      <a class="js-open-user" href="http://www.opposhop.cn/orders#">
        <img src="/myhome_files/icon-menu-user.png" alt="">
      </a>
      <div class="main-menu">
...
<div class="relative">
  <ul>
    ...
    <li class="user-menu-login user-menu-toLogin" style="display: none;">
      <a href="https://id.oppo.com/login?callback=http%3A%2F%2Fwww.opposhop.cn%2Forders">
        登录
      </a>
    </li>
    ...
    <div class="nav-search-content">
      <div class="nav-search-input">
        <form action="http://www.opposhop.cn/products" class="main-form">
          ...
          <a href="http://www.opposhop.cn/orders#" class="nav-search-close">取消</a>
        </form>
      </div>
    </div>
  </div>
...
<footer class="main-footer">
  ...
  <ul class="g">
    ...
    <div class="gi lap-one-quarter align-right">
      <div class="one-half lap-one-whole contact-online">
        <a href="http://oim.oppo.com/oim/chatClient/chatbox.jsp?companyID=8092&configID=890&enterurl=http%3A%2F%2Foim%2Emyoppo%2Ecom%2Foim%2Fpreview%2Ejsp&pagereferrer=http%3A%2F%2Foim%2Emyoppo%2Ecom%2Foim%2FembedScript%2Ejsp%3Ft%3D1517&k=1" target="_blank"><img src="/myhome_files/icon-online.png" alt=""></a>
      </div>
  ...
  <div class="g wrapper">
    ...
    <div class="wrapper">
        ...
        <a href="http://www.opposhop.cn/orders#" class="footer-focus-icon footer-focus-wechat relative">
          <span class="icon icon-wechat"></span>
          <img src="/myhome_files/qrcode-wx.jpg" class="wx-float" alt="" style="display: none;">
        </a>
        <a href="http://www.opposhop.cn/orders#" class="footer-focus-icon footer-focus-fuwuchuang relative">
          <span class="icon icon-fuwuchuang"></span>
          <img src="/myhome_files/qrcode-fwc.jpg" class="wx-float" alt="">
        </a>
      </div>
