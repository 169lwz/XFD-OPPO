...
<html class='no-js'>
  <head>
    ...
    <![endif]-->
    <script src="/qiantai/js/modernizr.custom.js"></script>
  </head>
    ...
    <div class='upper-area'>
      <div class='wrapper g'>
        <ul class='gi log-area'>
          ...
          <li class='gi' data-desktop='.upper-area .log-area' data-mobile='.mobile-tools .log-area'>
            <a class='logout' href='/home/logout'>退出</a>
          </li>
      ...
      <div class='main-menu'>
        ...
        <nav>
          <div class='nav-ul-view'>
            <ul class='menu g'>
              <li class='gi'>
                <a class='m-item' href='/home/index'><span>首页</span></a>
              </li>
              <li class='gi'>
                <a class='m-item' href='http://www.oppo.com/cn/products.html'><span>产品</span></a>
              </li>
              <li class='gi'>
                <a class='m-item' id='storeLink' href='/home/shangcheng' data-hd-url='http://hd.oppo.com/act/2016/1001/index.html'><span>商城</span></a>
              </li>
              <li class='gi'>
              ...
              <li class='gi'>
                <a class='m-item' href='http://www.coloros.com/' target="_blank">ColorOS</a>
              </li>
              <li class='gi'>
                <a class='m-item' href='http://www.oppo.cn/' target="_blank">社区</a>
              </li>
            </ul>
          </div>
        </nav>
        ...
        <div class="footer-sitemap">
          ...
          <div class="gi lap-one-quarter align-right">
            <div class="one-half lap-one-whole contact-online">
              <a href="http://oim.oppo.com/oim/chatClient/chatbox.jsp?companyID=8092&configID=890&enterurl=http%3A%2F%2Foim%2Emyoppo%2Ecom%2Foim%2Fpreview%2Ejsp&pagereferrer=http%3A%2F%2Foim%2Emyoppo%2Ecom%2Foim%2FembedScript%2Ejsp%3Ft%3D1517&k=1" target="_blank"><img src="/qiantai/images/icon-online.png" alt=""></a>
            </div>
  ...
  <div class="g wrapper">
    ...
    <div class='wrapper'>
        ...
        <a href='#' class='footer-focus-icon footer-focus-wechat relative'>
          ...
          <img src="/qiantai/images/qrcode-wx.jpg" class="wx-float" alt="">
        </a>
