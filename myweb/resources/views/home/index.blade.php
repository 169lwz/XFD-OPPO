...
<head>
 ...
 -->
  ...
  <style type="text/css">
    ...
    .mykq span{position: absolute;top:0;right: 0px;font-size: 25px; padding: 3px 40px;cursor: pointer;}
    @media  screen and (max-width: 750px){
        .mykq {text-align: left;line-height: 1.5}
        .mykq p{padding: 8px 30px 8px 0;}
        .mykq span{padding: 10px 20px;}
    }
</style>
</head>
<body>
 <header class='main-header'>
  ...
  <li class='gi hidden hasLogin' data-desktop='.upper-area .log-area' data-mobile='.mobile-tools .log-area'>
    <a class='logout' href='https://id.oppo.com/logout?callback=http%3A%2F%2Fwww.oppo.com%2Fcn%2F'>退出</a>
  </li>
    <li class='gi hasLogout' data-desktop='.upper-area .log-area' data-mobile='.mobile-tools .log-area'>
      <a href='https://id.oppo.com/login?callback=http%3A%2F%2Fwww.oppo.com%2Fcn%2F'>
        登录
      </a>
    </li>
  <li class='gi hasLogout' data-desktop='.upper-area .log-area' data-mobile='.mobile-tools .log-area'>
    <a href='../注册/index.html'>
      注册
    </a>
  </li>
...
<div class='relative'>
  <ul>
    ...
    <li class='user-menu-logout'>
      <a href='https://id.oppo.com/logout?callback=http%3A%2F%2Fwww.oppo.com%2Fcn%2F'>退出</a>
    </li>
  </ul>
</div>
</div>    </div>
...
<div class='nav-search'>
  ...
  <div class='hero-image center'>
    ...
    <picture>
      ...
      <source media='(min-width: 990px)' srcset='http://static.oppo.com/archives/201701/2017011205015658775324cc1fc.jpg' />
      <source media='(min-width: 750px)' srcset='http://static.oppo.com/archives/201701/20170112050159587753278b150.jpg' />
      <source media='(min-width: 300px)' srcset='images/201701120501025877532aab999.jpg' />
      <!--[if IE 9]> </video> <![endif]-->
      <img alt='' title='' src='images/201701120501025877532aab999.jpg' srcset='http://static.oppo.com/archives/201701/2017011205015658775324cc1fc.jpg'>
    </picture>
    </a>
  </div>
</div>
  ...
  <div class='hero-image center'>
    ...
    <picture>
      <!--[if IE 9]> <video style="display: none;"> <![endif]-->
      <source media='(min-width: 990px)' srcset='http://static.oppo.com/archives/201701/20170112060109587754993739e.jpg' />
      <source media='(min-width: 750px)' srcset='http://static.oppo.com/archives/201701/201701120601135877549dbb883.jpg' />
      <source media='(min-width: 300px)' srcset='images/20170112060118587754a25a06b.jpg' />
      <!--[if IE 9]> </video> <![endif]-->
      <img alt='' title='' src='images/20170112060118587754a25a06b.jpg' srcset='http://static.oppo.com/archives/201701/20170112060109587754993739e.jpg'>
    </picture>
    </a>
  </div>
</div>
  ...
  <div class='hero-image center'>
    ...
    <picture>
      <!--[if IE 9]> <video style="display: none;"> <![endif]-->
      <source media='(min-width: 990px)' srcset='http://static.oppo.com/archives/201701/201701110401455875eb1950678.jpg' />
      <source media='(min-width: 750px)' srcset='http://static.oppo.com/archives/201701/201701110401475875eb1b43305.jpg' />
      <source media='(min-width: 300px)' srcset='images/201701110401495875eb1d4db7a.jpg' />
      <!--[if IE 9]> </video> <![endif]-->
      <img alt='' title='' src='images/201701110401495875eb1d4db7a.jpg' srcset='http://static.oppo.com/archives/201701/201701110401455875eb1950678.jpg'>
    </picture>
    </a>
  </div>
</div>
  ...
  <a href='http://www.opposhop.cn/products/405.html' target='_blank'>
    <img alt='R9s' title="R9s" class='feature-product-image' src='images/201612300212245865fb4009681.jpg'>
  ...
  <a href='http://www.oppo.com/cn/blogs/video' target='_blank'>
    <img alt='小人国奇幻之旅' title="小人国奇幻之旅" class='feature-product-image' src='images/2017011106014958760701d13c4.jpg'>
    <div class='feature-product-content'>
      <h2 class='feature-product-heading'></h2>
      <p class='feature-product-description'>
        <strong></strong>
        ...
        <div class='feature-product'>
  <a href='http://www.oppo.com/cn/blogs/video' target='_blank'>
    <img alt='R9s 新年特别版视频' title="R9s 新年特别版视频" class='feature-product-image' src='images/20170105060105586e22c1aa2cd.jpg'>
    <div class='feature-product-content'>
      <h2 class='feature-product-heading'></h2>
      <p class='feature-product-description'>
        <strong></strong>
...
<script type="text/javascript">
  $(function () {
        var needMYKQShow = false;
    if(!OPPO.utils.getCookie('mykq_announcement') && needMYKQShow){
$(".upper-area").after("<div class=\"mykq\"><div class=\"wrapper\"><p>10月28日0点-11月4日0点，购买R9s且提交订单时输入口令“美因苛求2016”有惊喜，限前4000名！</p><span>×</span></div></div>");
}
$(".mykq span").on("click",function(){
    $(".mykq").hide();
    var curDate = new Date();  
    var curTamp = curDate.getTime();  
    var curWeeHours = new Date(curDate.toLocaleDateString()).getTime() - 1;  
    var passedTamp = curTamp - curWeeHours;
    var leftTamp = 1 -  passedTamp/(24 * 60 * 60 * 1000);
    OPPO.utils.setCookie('mykq_announcement',true,leftTamp);
})
      });
</script>
<!-- 百度统计代码  -->
