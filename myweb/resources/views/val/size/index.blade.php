...
<div class="mws-panel grid_8">
	<div class="mws-panel-header">
		<span><i class="icon-table"></i> 商品尺寸浏览</span>
	</div>
	<div role="grid" class="dataTables_wrapper" id="DataTables_Table_1_wrapper">
		<form action='/admin/val/indexsize' method='get'>	<!--要传参数,自己提交给自己,所以用get-->
				...
				<table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
		            <thead>
		                <tr role="row">
			                ...
			                <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 316px;" aria-label="Platform(s): activate to sort column ascending">手机尺寸</th>
		                	...
		                	@foreach($list as $k=>$v)
				                ...
				                @endif
				                        ...
				                        <td class=" " align='center' font-size='30px'>
				                        	<a href='/admin/val/delsize/{{$v['id']}}' class="icon-trash" style='font-size:25px;color:red' title='删除'></a> | 
				                        	<a href='/admin/val/editsize/{{$v['id']}}' class="icon-cogs" style='font-size:25px;color:green' title='修改'></a>
				                        </td>
				                    </tr>
		                   	@endforeach
		                </tbody>
