...
<div class="mws-panel grid_8">
	<div class="mws-panel-header">
		<span><i class="icon-table"></i> 商品颜色浏览</span>
	</div>
				...
				<table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
		            <thead>
		                <tr role="row">
			                ...
			                <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 316px;" aria-label="Platform(s): activate to sort column ascending">商品图片</th>
		                ...
		                <tbody role="alert" aria-live="polite" aria-relevant="all">
		                	@foreach($list as $k=>$v)
				                ...
				                @endif
				                        <td class=" ">{{$v['id']}}</td>
				                        <td class=" ">{{$v['gid']}}</td>           
				                        <td class=" "><img src="{{$v['gpic']}}" width="60px"></td>
				                        <td class=" ">{{$v['color']}}</td>				                       
				                        <td class=" " align='center' font-size='30px'>
				                        	<a href='/admin/val/delcolor/{{$v['id']}}' class="icon-trash" style='font-size:25px;color:red' title='删除'></a> | 
				                        	<a href='/admin/val/editcolor/{{$v['id']}}' class="icon-cogs" style='font-size:25px;color:green' title='修改'></a>
				                        </td>
				                    </tr>
		                   	@endforeach
		                </tbody>
