...
<div class="mws-panel grid_8">
     <div class="mws-panel-header"><span>商品颜色修改</span></div>
    <div class="mws-panel-body no-padding">
     <form action="/admin/val/updatecolor" class="mws-form" method="post" enctype="multipart/form-data">
          {{csrf_field()}}
          ...
          <div class="mws-form-inline">
              ...
              <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                         <img src="{{$vo['gpic']}}" alt="" width="100px">
                    </div>
              </div>
              <div class="mws-form-row">
