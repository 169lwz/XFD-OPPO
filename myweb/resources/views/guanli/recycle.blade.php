...
<div class="mws-panel grid_8">
	<div class="mws-panel-header">
		<span><i class="icon-table"></i>回收用户浏览</span>
	</div>
	<div role="grid" class="dataTables_wrapper" id="DataTables_Table_1_wrapper">
		<form action='/admin/guanli/rubbish' method='get'>	<!--要传参数,自己提交给自己,所以用get-->
				...
				<table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
		            <thead>
		                <tr role="row">
			                ...
			                <!-- <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 221px;" aria-label="Engine version: activate to sort column ascending">email</th> -->
				                ...
				                @endif
				                       ...
				                       <!--  <td class=" ">
				                        ...
				                        <td class=" " align='center' font-size='30px'>
				                        	<a href='/admin/guanli/del/{{$v['id']}}' class="icon-trash" style='font-size:25px;color:red' title='彻底删除'></a> | <a href='/admin/guanli/reuse/{{$v['id']}}' class="icon-ok" style='font-size:25px;color:green' title='恢复使用'></a>
				                        </td>
				                    </tr>
		                   	@endforeach
		                </tbody>
