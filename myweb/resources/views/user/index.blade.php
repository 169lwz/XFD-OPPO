...
<div class="mws-panel grid_8">
	...
	<div role="grid" class="dataTables_wrapper" id="DataTables_Table_1_wrapper">
		<form action='/admin/user/index' method='get'>	<!--要传参数,自己提交给自己,所以用get-->
		                	...
		                	@foreach($list as $k=>$v)
				                ...
				                @endif
				                        ...
				                        <td class=" " align='center' font-size='30px'>
				                        	<a href='/admin/user/hs/{{$v['id']}}' class="icon-trash" style='font-size:25px;color:red' title='放入回收站'></a> | <a href='/admin/user/edit/{{$v['id']}}' class="icon-cogs" style='font-size:25px;color:green' title='修改'></a>
				                        </td>
				                    </tr>
		                   	@endforeach
		                </tbody>
