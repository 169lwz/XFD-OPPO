...
<div class="mws-panel grid_8">
	...
	<div role="grid" class="dataTables_wrapper" id="DataTables_Table_1_wrapper">
		<form action='/admin/user/rubbish' method='get'>	<!--要传参数,自己提交给自己,所以用get-->
				                ...
				                @endif
				                       ...
				                       <!--  <td class=" ">
				                        ...
				                        <td class=" " align='center' font-size='30px'>
				                        	<a href='/admin/user/del/{{$v['id']}}' class="icon-trash" style='font-size:25px;color:red' title='彻底删除'></a> | <a href='/admin/user/reuse/{{$v['id']}}' class="icon-ok" style='font-size:25px;color:green' title='恢复使用'></a>
				                        </td>
				                    </tr>
		                   	@endforeach
		                </tbody>
