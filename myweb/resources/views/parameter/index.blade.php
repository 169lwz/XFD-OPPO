...
<div class="mws-panel grid_8">
	<div class="mws-panel-header">
		<span><i class="icon-table"></i> 商品参数浏览</span>
	</div>
		                ...
		                <tbody role="alert" aria-live="polite" aria-relevant="all">
		                	@foreach($list as $k=>$v)
				                ...
				                @endif
				                        ...
				                        <td class=" "><img src="{{$v['ppic4']}}" alt="" width="60px"></td>
				                        <td class=" "><img src="{{$v['ppic5']}}" alt="" width="60px"></td>
				                        <td class=" "><img src="{{$v['ppic6']}}" alt="" width="60px"></td>				            				                       				                                   
				                        <td class=" " align='center' font-size='30px'>
				                        	<a href='/admin/parameter/del/{{$v['id']}}' class="icon-trash" style='font-size:25px;color:red' title='删除'></a> | 
				                        	<a href='/admin/parameter/edit/{{$v['id']}}' class="icon-cogs" style='font-size:25px;color:green' title='修改'></a>
				                        </td>
				                    </tr>
		                   	@endforeach
		                </tbody>
